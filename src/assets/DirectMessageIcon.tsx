...
const DirectMessageIcon: React.FC<ISVG> = ({color, filled}) => {
      ...
      <SVGWrapper color={color}>
        {filled ? (
            ...
            >
              <g>
                <path
                    d="M11.55 12.082c.273.182.627.182.9 0L22 5.716V5.5c0-1.24-1.01-2.25-2.25-2.25H4.25C3.01 3.25 2 4.26 2 5.5v.197l9.55 6.385z"></path>
                <path
